...
public class RecCircleTest
{
	 ...
	 */
	public static void circlere(double radius, int Current) throws InterruptedException
	// expanding circle
	{
		// YOUR MASTERPIECE CODE GOES HERE!
		StdDraw.circle(middleX, middleY, Current);
		Thread.sleep(250);
		if(radius == Current)
		{	return;
		} else
		{	circlere(radius, Current+1);
	}
}
	...
	// shrinking circle
	{
		...
		Thread.sleep(250); // wait a second
